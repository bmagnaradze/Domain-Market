import { IBreakpoints } from '../types/breakpoints.types';
...
export const breakpointsBetween: IBreakpoints = {
  small: getMaxBreakPoint(breakpointValues.small),
  medium: `${getMinBreakPoint(
    breakpointValues.medium + 1
  )} and ${getMaxBreakPoint(breakpointValues.large)}`,
  large: `${getMinBreakPoint(
    breakpointValues.large + 1
  )} and ${getMaxBreakPoint(breakpointValues.xlarge)}`,
  xlarge: `${getMinBreakPoint(
    breakpointValues.xlarge + 1
  )} and ${getMaxBreakPoint(breakpointValues.xxlarge)}`,
  xxlarge: getMinBreakPoint(breakpointValues.xxlarge + 1),
};
